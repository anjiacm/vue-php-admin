          ...
          <el-card class="box-card user-bio">
            ...
            <div class="user-education user-bio-section">
              ...
              <div class="user-bio-section-body">
                <div class="text-muted">B.S. in Computer Science from the University of Technology</div>
              </div>
            </div>
                    ...
                    <el-timeline-item timestamp="2019/4/22" placement="top">
                      <el-card>
                        <h4>
                          Deploy
                          <a
                            href="https://Panjiachen.github.io/vue-element-admin/"
                            target="_blank"
                          >vue-template-admin</a>
                        </h4>
...
export default {
  ...
  methods: {
    getUser() {
      console.log('mapGetters...', this.name, this.avatar, this.roles)
      this.user = {
        name: this.name,
